...
//                                $tag = '/Web-Project/index.php/Store/view_selected_product/'.$row->product_id;
                echo '<div class="w3-quarter w3-section w3-light-grey product-section" style="margin-right:5%; padding: 2%; max-width: 30%;">';
                echo '<span class="w3-xlarge"><img class="product-img" src=' . base_url() . $row->image_path . ' width="200px"></span><br>';
                echo "<strong class='product-name'>$row->name</strong><hr>";
