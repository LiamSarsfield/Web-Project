...
<nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center">
    ...
    <div id="mySidenav" class="sidenav">
        ...
        <a href="<?php echo site_url() ?>/Store_controller/view_store"
...
//         echo '<img src="'.base_url().'/assets/images/cb.jpg" alt="product picture"'.$row->product_name.'" width="100px">';
                        ...
                        echo '<td>';
                        echo '<a href="' . base_url() . 'index.php/Shopping_cart_controller/remove_product_from_cart/' . $row->shopping_cart_id . '"><button>Remove</button></a>';
                        echo '</td>';
                    }
                }
                ?>
            ...
            <button class="w3-bar-item w3-button w3-padding-large w3-hover-black">
                <a href="<?php echo base_url() ?>index.php/Shopping_cart_controller/checkout"
