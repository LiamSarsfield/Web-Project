...
<div class="w3-padding-large" id="main">
  ...
  <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
        ...
        <main style="width:80%; margin-left:10%;">
            <form action="<?php echo site_url()?>/Product/goodsNoteCreate" class="search_product_id generic_search">
                <fieldset>
            ...
            <table class="table_generic">
                <tbody>
                    <tr>
                        ...
                        <th scope="col">Create Credit Note</th>
                    </tr>
                    <tr>
                        <td>101</td>
                        <td>Keith Clifford</td>
                        <td>keithclifford500@gmail.com</td>
                        <td><a href="<?php echo site_url()?>/Product/goodsNoteCreate"><div class="button">Create</div></a></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
