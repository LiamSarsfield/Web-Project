...
<main style="width:40%; margin-left:30%;">
<a href="<?php echo site_url()?>/Product/travellerUpdateInfo"><div class="button">Back to View Lot Traveller</div></a>

<form action="<?php echo site_url()?>/Product/travellerUpdateInfo">
