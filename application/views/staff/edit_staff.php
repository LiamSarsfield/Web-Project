<main>
    <a href="<?php echo site_url("functions/view/staff/{$staff_info->staff_id}") ?>">
        <div class="button">Back to View Staff</div>
    </a>

    <?php echo form_open(site_url('Staff/edit_staff/' . $staff_info->staff_id)) ?>
    <fieldset class="generic_edit_item_form">
        <p>* is required.</p>
        <legend>Edit Staff</legend>
        <p>
            <label for="staff_id">Staff ID: </label>
            <input name="staff_id" class="generic_input" type="text"
                   value="<?php echo $staff_info->staff_id ?>" readonly="readonly">
        </p>
        ...
        <p>
            ...
            <input name="dob" class="generic_input" type="text"
                   value="<?php echo (empty(set_value("dob"))) ? $staff_info->postal_code : set_value("dob"); ?>">
        </p>
        <p>
            <label for="hired_date">Hired Date:* </label>
            <input name="hired_date" class="generic_input" type="date"
                   value="<?php echo (empty(set_value("hired_date"))) ? $staff_info->hired_date : set_value("hired_date"); ?>">
        </p>
        <p>
            <label for="left_date">Left Date: </label>
            <input name="left_date" class="generic_input" type="date"
                   value="<?php echo (empty(set_value("left_date"))) ? $staff_info->left_date : set_value("left_date"); ?>">
        </p>
        <p>
            <label for="position">Position:* </label>
            <input name="position" class="generic_input" type="text"
                   value="<?php echo (empty(set_value("position"))) ? $staff_info->position : set_value("position"); ?>">
        </p>
        <p>
