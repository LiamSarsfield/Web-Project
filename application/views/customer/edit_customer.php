<main>
    ...
    <?php echo form_open(site_url('Customer/edit_customer/' . $customer_info->customer_id)) ?>
    <fieldset class="generic_edit_item_form">
        <p>* is required.</p>
        <legend>Edit Customer</legend>
        <p>
            <label for="customer_id">Customer ID: </label>
            <input name="customer_id" class="generic_input" type="text"
                   value="<?php echo $customer_info->customer_id ?>" readonly="readonly">
        </p>
