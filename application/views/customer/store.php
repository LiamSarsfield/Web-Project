...
<link rel="stylesheet" href="<?php echo base_url(); ?>/assests/CSS/w3.css">
    ...
    <div class="w3-content w3-justify w3-text-grey w3-padding-64" id="about">
        ...
        <div class="w3-row w3-center w3-padding-16 w3-section w3-light-grey">
            <div class="w3-quarter w3-section">
                <span class="w3-xlarge"><img src="circuit_board.jpg" alt="circuit_board" class="w3-image" width="620"
                                             height="420"></span><br>
