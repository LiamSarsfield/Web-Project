  ...
  <nav>
    <ul>
      ...
      <li><a href="view_products.html">Production</a></li>
        ...
        <main>
            <a href="searchquotes.html"><div class="button">Back to View All Quotes</div></a>
            ...
            <section class="generic_section generic_item_information">
                ...
                <div class="generic_item_content">
                    <a href="payquote.html"><div class="button">Pay Quote</div></a>
                    <a href="declinequote.html"><div class="button">Decline Quote</div></a>
                </div>
            </section>
        </main>
    </body>
