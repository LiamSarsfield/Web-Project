...
<main style="margin-left:10%; margin-right:10%;">
            <?php echo form_open('Shopping_cart_controller/payment_authorisation'); ?>

                <fieldset class="generic_edit_item_form">
                        <h2 class="generic_item_header">Payment</h2>
                        <p>
                        ...
                        <p>
                            ...
                            <input class="generic_input" name="total" type="text" value="200" disabled>
                        </p>
