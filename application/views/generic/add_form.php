            ...
            foreach ($form_field_data as $form_field) { ?>
                ...
                <?php } else { ?>
                    ...
                    <input name='<?php echo "{$table_name}[{$form_field->label}]"; ?>'
                           type='<?php echo ($form_field->data_type == "date") ? "date" : "text"; ?>' <?php // echo $form_field->is_required; ?>
                           id='<?php echo $form_field->label; ?>' value='<?php echo ($form_field->data_type == "date") ? date("Y-m-d") : "" ?>'>
                    </p>
                <?php } ?>
