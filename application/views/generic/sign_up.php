...
<div class="w3-padding-64 w3-content w3-text-grey" id="contact">
    ...
    <p><input class="w3-input w3-padding-16" type="text" placeholder="First Name" required name="first_name" value="<?php echo set_value('first_name'); ?>"></p>
    <?php echo form_error('last_name'); ?>
    <p><input class="w3-input w3-padding-16" type="text" placeholder="Last Name" required name="last_name" value="<?php echo set_value('last_name'); ?>"></p>
    <?php echo form_error('email'); ?>
    <p><input class="w3-input w3-padding-16" type="text" placeholder="Email" required name="email" value="<?php echo set_value('email'); ?>"></p>
    <?php echo form_error('password'); ?>
    <p><input class="w3-input w3-padding-16" type="text" placeholder="Password" required name="password" value="<?php echo set_value('password'); ?>"></p>
    <?php echo form_error('phone'); ?>
    <p><input class="w3-input w3-padding-16" type="text" placeholder="Phone" required name="phone" value="<?php echo set_value('phone'); ?>"></p>
    <?php echo form_error('company'); ?>
    <p><input class="w3-input w3-padding-16" type="text" placeholder="Company Name (Optional)" required name="company" value="<?php echo set_value('company'); ?>"></p>
    <?php echo form_error('address_one'); ?>
    <p><input class="w3-input w3-padding-16" type="text" placeholder="Street Address" required name="address_one" value="<?php echo set_value('address_one'); ?>"></p>
