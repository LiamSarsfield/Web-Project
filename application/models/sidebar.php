...
class sidebar extends CI_Model
{
    ...
    public function get_sidebars_by_permission($name = "unregistered")
    {
        ...
        foreach ($sidebar_ids as $sidebar_id) {
            ...
            $permitted_sub_sidebar_ids = $this->get_permitted_sub_sidebar_ids_by_permission_id($permission_id, $sidebar_id);
    ...
    public function get_permitted_sub_sidebar_ids_by_permission_id($permission_id = "0", $sub_sidebar_id = "0")
    {
        $this->db->select("permission_id, sub_sidebar_id");
        $this->db->where('permission_id', $permission_id);
